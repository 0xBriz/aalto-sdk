export const NODE_ABI = [
  ...
  {
    inputs: [
      { internalType: 'address payable', name: 'newDev', type: 'address' },
    ],
    name: 'changeDev',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'nodeTier', type: 'uint256' },
      { internalType: 'uint256', name: 'numNodes', type: 'uint256' },
    ],
    name: 'create',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'amnt', type: 'uint256' },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256[]', name: '_nodes', type: 'uint256[]' },
    ],
    name: 'setNodes',
    outputs: [],
    stateMutability: 'nonpayable',
    ...
    inputs: [
      { internalType: 'address', name: '_addr', type: 'address' },
      {
        components: [
          ...
          { internalType: 'uint256', name: 'total_claims', type: 'uint256' },
          { internalType: 'uint256', name: 'last_distPoints', type: 'uint256' },
        ],
        internalType: 'struct Node.User',
        name: '_user',
        type: 'tuple',
      },
    ],
